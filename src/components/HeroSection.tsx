        ...
        <>
          ...
          <span className="relative inline-flex h-[1.05em] overflow-hidden align-baseline leading-none">
            <span className="animate-scroll-words flex flex-col will-change-transform text-3xl sm:text-5xl md:text-6xl leading-none">
              <span className="block drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]" style={{ color: '#57C785' }}>AI</span>
              <span className="block drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]" style={{ color: '#57C785' }}>Business</span>
              <span className="block drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]" style={{ color: '#57C785' }}>Digital</span>
            </span>
          </span>
